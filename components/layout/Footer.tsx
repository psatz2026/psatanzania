            ...
            <div className="flex items-center gap-4">
              {socialLinks.map((s) => (
                <a
                  ...
                  aria-label={s.label}
                  className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-white/70 hover:bg-sky-blue hover:text-white transition-all duration-200"
                >
                  {s.icon}
                </a>
              ))}
