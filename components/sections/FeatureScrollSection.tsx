...
const features = [
  {
    ...
    href: "/become-a-volunteer#volunteer",
    icon: (
  ...
  },
  {
    ...
    description: "Join the alliance and help shape safer, patient-centred care across Tanzania.",
    href: "/become-a-volunteer#membership",
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="currentColor">
        <path
          fillRule="evenodd"
          d="M7.5 6a4.5 4.5 0 1 1 9 0 4.5 4.5 0 0 1-9 0ZM3.751 20.105a8.25 8.25 0 0 1 16.498 0 .75.75 0 0 1-.437.695A12.673 12.673 0 0 1 12 22.5c-2.049 0-4.01-.49-5.752-1.35a.75.75 0 0 1-.437-.695Z"
          clipRule="evenodd"
        />
      </svg>
    ),
  ...
  },
  {
    ...
    icon: (
      <svg width="30" height="30" viewBox="0 0 512 512" fill="currentColor">
        ...
        <circle cx="259.244" cy="141.566" r="87.125" mask="url(#psa-coin-dollar)" />
      </svg>
    ),
  },
  {
    title: "Donate",
    description: "Every contribution helps us expand patient safety education and advocacy.",
    href: "/contact#donate",
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="lg:hidden flex flex-col gap-6 pt-[60px]">
          ...
          {features.map((feature) => (
            <Link
              key={feature.title}
              href={feature.href}
              className="bg-white rounded-2xl border border-sky-blue/20 shadow-[0_2px_16px_rgba(27,56,136,0.07)] p-6 flex flex-col gap-5 transition-[border-color,box-shadow,transform] duration-200 ease-out hover:border-sky-blue/40 hover:shadow-[0_4px_20px_rgba(27,56,136,0.1)] focus:outline-none focus-visible:ring-2 focus-visible:ring-sky-blue/50 focus-visible:ring-offset-2 active:scale-[0.99]"
            >
              ...
              <span className="font-body text-[15px] font-medium text-sky-blue inline-flex items-center gap-1.5">
                Learn more
